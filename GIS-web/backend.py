                    ...
                    try:
                        ...
                        if line.startswith('$'):
                            ...
                            if msg.sentence_type == 'GGA':  # GPS position data
                                ...
                                gps_data["lat_dir"] = msg.lat_dir
                                gps_data["longitude"] = msg.longitude
                                gps_data["lon_dir"] = msg.lon_dir
                                gps_data["altitude"] = msg.altitude if msg.altitude else 0
                                ...
                                gps_data["timestamp"] = f"{msg.datetime.strftime('%Y-%m-%d %H:%M:%S') if msg.datestamp else '--'}"
                                gps_data["latitude"] = msg.latitude
                                gps_data["lat_dir"] = msg.lat_dir
                                gps_data["longitude"] = msg.longitude
                                gps_data["lon_dir"] = msg.lon_dir
